...
function(exports, scenegraph, animation) {
	...
	function init() {
		...
		var sun = scenegraph.createNodeWithModel("sun", "sphere", {recursionDepth: 2}, null, true);
        animation.assign(sun, "rotate", {rotationSpeed: [0, 0.01, 0]});

        var earth = scenegraph.createNodeWithModel("earth", "sphere", {recursionDepth: 2, scale: 100}, sun);
        earth.translate([800, 0, 0]);
        animation.assign(earth, "rotate", {rotationSpeed: [0, 0.03, 0]});

        var moon = scenegraph.createNodeWithModel("moon", "sphere", {recursionDepth: 2, scale: 50}, earth);
